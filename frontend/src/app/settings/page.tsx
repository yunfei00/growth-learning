...
function FamilySettingsContent() {
  ...
  return (
    <section className="settings-page section-shell">
      <header><p className="eyebrow">Family settings</p><h1>家庭设置</h1><p className="role-note">成长鼓励由家庭选择；它不改变学习证据或知识掌握状态。</p><div className="settings-header-actions"><Link className="button button-primary" href="/settings/family">家庭成员与孩子</Link><Link className="button button-secondary" href="/settings/account">账号与安全</Link></div></header>
